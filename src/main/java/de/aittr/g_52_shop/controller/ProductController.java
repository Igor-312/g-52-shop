...
public class ProductController {
    ...
    // что бы могли в коде контролера вызывать его методы.
...
//    public void update(@RequestBody Product product) {
    ...
    // GET -> http://12.34.56.78:8080/products/quantitty
    @GetMapping("/quantity")
    ...
    @GetMapping("/avg-cost")
    public BigDecimal getProductsAverageCost() {
    ...
    2. Т.К. эксепшен в сервисе не обрабатывается, но он пробрасывается
    ...
    4. Спринг вызывает сам наш метод handleException, передавая в параметр е
